...
class KLeptonSelector : public edm::EDFilter
{
public:
  KLeptonSelector(const edm::ParameterSet& pset);
  ~KLeptonSelector() {};
...
template<typename Lepton>
KLeptonSelector<Lepton>::KLeptonSelector(const edm::ParameterSet& pset)
{
...
template<typename Lepton>
bool KLeptonSelector<Lepton>::filter(edm::Event& event, const edm::EventSetup& eventSetup)
{
...
template<typename Lepton>
void KLeptonSelector<Lepton>::makeIsoVeto(const pat::Electron& electron, reco::IsoDeposit::AbsVetos& vetos_ch, reco::IsoDeposit::AbsVetos& vetos_nh, reco::IsoDeposit::AbsVetos& vetos_ph)
{
...
template<typename Lepton>
void KLeptonSelector<Lepton>::makeIsoVeto(const pat::Muon& muon, reco::IsoDeposit::AbsVetos& vetos_ch, reco::IsoDeposit::AbsVetos& vetos_nh, reco::IsoDeposit::AbsVetos& vetos_ph)
{
...
template<typename Lepton>
double KLeptonSelector<Lepton>::getEffectiveArea(const pat::Electron& electron)
{
...
typedef KLeptonSelector<pat::Muon> KMuonSelector;
typedef KLeptonSelector<pat::Electron> KElectronSelector;

DEFINE_FWK_MODULE(KMuonSelector);
DEFINE_FWK_MODULE(KElectronSelector);
